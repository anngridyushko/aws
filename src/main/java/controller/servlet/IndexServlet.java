...
public class IndexServlet extends HttpServlet
{
    ...
    {
        var folders = folderDAO.readFolders();
        request.setAttribute("downloadFiles", folders);

        var dispatcher = request.getRequestDispatcher("/WEB-INF/view/index.jsp");
...
//                bos.close();
//
//                String bucketName = "bylex-practice-bucket";
